...
export default function Lab1() {
  return (
    <div id="wd-lab1">
      ...
      My favorite recipe (Tuscan Chicken Pasta):
      <ol id="wd-your-favorite-recipe">
        <li>
          Season chicken with salt, pepper, and Italian herbs, then sear until
          golden.
        </li>
        <li>Sauté garlic and sun-dried tomatoes in the same pan.</li>
        <li>
          Add heavy cream and parmesan, stirring to create a creamy sauce.
        </li>
        <li>Return the chicken to the pan and let it simmer in the sauce.</li>
        <li>
          Toss in cooked pasta and fresh spinach until everything is well
          coated.
        </li>
        <li>Serve warm with extra parmesan on top.</li>
      </ol>
